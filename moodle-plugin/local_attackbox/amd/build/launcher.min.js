...
define(["jquery", "core/str"], function ($, Str) {
  ...
  class AttackBoxLauncher {
    ...
    constructor(config, strings) {
      ...
      this.attackTypes = [
        { name: "SQL Injection", icon: "ðŸ’‰", color: "#ff5722" },
        { name: "XSS Attack", icon: "âš¡", color: "#ff9800" },
        { name: "Phishing", icon: "ðŸŽ£", color: "#f44336" },
        { name: "Port Scan", icon: "ðŸ”", color: "#00bcd4" },
        { name: "Brute Force", icon: "ðŸ”¨", color: "#9c27b0" },
        { name: "Man-in-Middle", icon: "ðŸ‘ï¸", color: "#673ab7" },
        { name: "DoS Attack", icon: "ðŸ’¥", color: "#e91e63" },
        { name: "Buffer Overflow", icon: "ðŸ“¦", color: "#ff5722" },
      ];
      ...
      const html = `
        <div id="attackbox-quota-notification" class="attackbox-quota-notification" style="display: none;">
          <div class="attackbox-notification-content">
            <span class="attackbox-notification-icon">âš ï¸</span>
    ...
    createUsageDashboardLink() {
      const html = `
        <a href="${M.cfg.wwwroot}/local/attackbox/usage.php" 
           ...
           target="_blank">
          <span class="attackbox-usage-link-icon">ðŸ“Š</span>
                            ...
                            <div class="attackbox-terminal">
                                ...
                                <div class="attackbox-terminal-body">
                                    <div id="attackbox-status-message" class="attackbox-status-message">
                                        <span class="attackbox-cursor">â–‹</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="attackbox-edu-visual">
                                <div id="attackbox-attack-viz" class="attackbox-attack-viz">
                                    <div class="attackbox-attack-node attackbox-attacker">
                                        <span class="attackbox-node-icon">ðŸ‘¤</span>
                                    ...
                                    <div class="attackbox-attack-node attackbox-target">
                                        <span class="attackbox-node-icon">ðŸŽ¯</span>
